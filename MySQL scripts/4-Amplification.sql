...
CREATE TABLE `Amplification` (
  ...
  `amp timestamp` varchar(100) NOT NULL,
  -- PRIMARY KEY (`sample_ID`),
  -- UNIQUE KEY `sample_ID_UNIQUE` (`sample_ID`),
  CONSTRAINT `sample_ID FK` FOREIGN KEY (`sample_ID`) REFERENCES `Sampling` (`sample_ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `Amplification` WRITE;
/*!40000 ALTER TABLE `Amplification` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `Amplification` ENABLE KEYS */;
UNLOCK TABLES;
